  ...
  tryCatch(
    {
      ...
      rule_rent_alipay            <-  c("rule_suanhua_G1_payday","rule_xinyan","rule_xinyan_error","rule_suanhua_error","rule_region","rule_age","rule_sanyaosu","rule_zaiwang","rule_zmscore","rule_zrobot_sc_zrxy_zm")
      rule_rent_alipay_app        <-  c("rule_suanhua_G1_payday","rule_xinyan","rule_xinyan_error","rule_suanhua_error","rule_region","rule_age","rule_sanyaosu","rule_zaiwang","rule_zmscore","rule_txl","rule_zrobot_sc_zrxy_zm")
      ...
      rule_apv_skip_throuth       <-   c("rule_suanhua_G1_payday","rule_xinyan","rule_xinyan_error","rule_suanhua_error","rule_sanyaosu","rule_zaiwang","rule_apv_skip_through_of_zmscore_huabei"
                                         ...
                                         ,"rule_zrobot_idcard_in_blacklist","rule_zrobot_sn_order1_blacklist_contacts_cnt","rule_zrobot_sc_zrxy_zm")
      rule_alipay_apv_skip_throuth <-  c("rule_suanhua_G1_payday","rule_xinyan","rule_xinyan_error","rule_suanhua_error","rule_sanyaosu","rule_zaiwang","rule_apv_skip_through_of_zmscore_huabei","rule_zrobot_sc_zrxy_zm")
