...
public class SimpleHttpClient {
	...
	public void enableSSL() {
		/*
		 * try { httpclient .getConnectionManager() .getSchemeRegistry()
		 * .register( new Scheme("https", 443, new SSLSocketFactory( new
		 * TrustStrategy() {
		 * 
		 * @Override public boolean isTrusted( X509Certificate[] chain, String
		 * authType) throws CertificateException { return true; } }))); } catch
		 * (Exception e) { // }
		 */
		try {
