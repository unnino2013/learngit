...
public interface ErrorConstant {
    ...
    public static final int ERROR_CODE = 69000000;
    public static final int PARAM_ERROR_CODE = ERROR_CODE + 1;
    public static final int SECRETKEY_ERROR_CODE = ERROR_CODE + 2;
    public static final int MD5_ERROR_CODE = ERROR_CODE + 3;
    public static final int HTTPCLIENT_ERROR_CODE = ERROR_CODE + 4;
    public static final int LOAD_PROPERTY_FILE_ERROR_CODE = ERROR_CODE + 5;
    public static final int HBASH_CONNECTION_ERROR_CODE = ERROR_CODE + 6;
